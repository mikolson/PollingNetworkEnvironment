...
public class BadanieArt_4_2 extends Badanie2Metod {
	...
	private static final int T_ITERACJI =1700;
	private static final float T_KONIEC = 4f;
	private static final float T_START = 70f;
	float c1 = 50;
	float c2 = 20;
	float c3 = 20;
	float c4 = 20;
	...
	int[] intentywnosciNaplywu2 = new int[] {30,50,5};
	...
	public BadanieArt_4_2() {
		...
		setParametryEksperymentu(12000, 15, 25);
	}
	
	@Override
	protected void konfiguracjaGeneratoraLiczb() {
		RandomGenerator.setDefaultSeed(122221);
	}	
