...
public class BadanieRep_2 extends Badanie2Metod {
   	
	private static final int T_ITERACJI = 25000;
	private static final float T_KONIEC = 6f;
	...
	public BadanieRep_2() {
		...
		setParametryEksperymentu(100000, 3, 50);
	}
	
	@Override
	protected void konfiguracjaGeneratoraLiczb() {
		RandomGenerator.setDefaultSeed(123123322);
	}	
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		BadanieRep_2 badanie = new BadanieRep_2();
