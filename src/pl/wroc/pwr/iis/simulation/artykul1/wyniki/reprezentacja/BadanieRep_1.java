...
public class BadanieRep_1 extends Badanie2Metod {
   	
	private static final int T_ITERACJI = 40000;
	...
	public BadanieRep_1() {
		...
		setParametryEksperymentu(1000000, 2, 1000);
	}
	
	@Override
	protected void konfiguracjaGeneratoraLiczb() {
		RandomGenerator.setDefaultSeed(1231222);
	}	
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		BadanieRep_1 badanie = new BadanieRep_1();
