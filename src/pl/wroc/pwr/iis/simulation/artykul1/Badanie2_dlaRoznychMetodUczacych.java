...
public class Badanie2_dlaRoznychMetodUczacych extends Badanie2Metod {
	private static final int T_ITERACJI = 5000;
	private static final float T_KONIEC = 2f;
	private static final float T_START = 30f;
	float c1 = 50;
	float c2 = 50;
	float c3 = 50;
	float C4 = 30;
	...
	float alfa = 0.08f; // poprawa Q
	float gamma = 0.5f; // 
	
	public Badanie2_dlaRoznychMetodUczacych() {
...
//    	serwer1.setMaxCzasOczekiwania(200); 
    	serwerBadania.getKolejka(0).setMaxCzasOczekiwania(50);
    	serwerBadania.getKolejka(1).setMaxCzasOczekiwania(10);
    	serwerBadania.getKolejka(2).setMaxCzasOczekiwania(20);
...
//
	...
	public static void main(String[] args) {
		Badanie2_dlaRoznychMetodUczacych badanie = new Badanie2_dlaRoznychMetodUczacych();
