...
public class Badanie3 extends Badanie2Metod {
	private static final int T_ITERACJI = 5000;
	private static final float T_KONIEC = 1.5f;
...
//		setParametryEksperymentu(300000, 30, 3000);
		setParametryEksperymentu(300000, 3, 3000);
...
//
		Strategia_A strategiaEzachlanna = new StrategiaSoftMax(T_START, T_KONIEC, T_ITERACJI*10 , serwerBadania.getMaxStanow(), serwerBadania.getIloscAkcji());
