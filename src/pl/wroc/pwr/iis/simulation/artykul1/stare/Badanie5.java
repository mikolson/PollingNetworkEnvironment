...
//    	serwer1.setMaxCzasOczekiwania(200); 
    	...
    	serwer1.getKolejka(1).setMaxCzasOczekiwania(30);
...
//    	serwer1.setRozkladIlosciPrzybyc(new RozkladRownomierny(0,3));
    		...
    		serwer1.getKolejka(2).setRozkladIlosciPrzybyc(new RozkladBernouliego(55));
