...
//    	serwer1.setRozkladIlosciPrzybyc(new RozkladRownomierny(0,3));
		...
		float c2 = 10;
		float c3 = 50;
		float c3_2 = 50/(float)3;
		float eStart = 0.8f;
		float eKoniec = 0.05f;
		float eZachlannosc = 0.05f;
		int eKrokow = 10000;
...
//		FunkcjaOceny_I fOceny = new OcenaTimeRosnacoTuning_WLASNA(c1,c2,c3_2);
		serwer1.setFunkcjaOceny(fOceny);

		Strategia_A strategiaEzachlanna= new StrategiaEZachlanna(eZachlannosc, serwer1.getMaxStanow(), serwer1.getIloscAkcji());
//		Strategia_A strategiaEzachlanna= new StrategiaEZachlannaDynamiczna(eStart,eKoniec,eKrokow, serwer1.getMaxStanow(), serwer1.getIloscAkcji());
