...
public class SredniSoftMaxa extends Badanie2Metod {
   	
	private static final int T_ITERACJI = 1500;
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		SredniSoftMaxa badanie = new SredniSoftMaxa();
