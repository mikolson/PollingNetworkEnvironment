...
public class NiskieNatezenia extends Badanie2Metod {
	...
	int[] intentywnosciNaplywu = new int[] {5,5,5,30};
	...
	public NiskieNatezenia() {
		int iloscCykli = 5000; 
		int zmianaCyklu = 45000;
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		NiskieNatezenia badanie = new NiskieNatezenia();
