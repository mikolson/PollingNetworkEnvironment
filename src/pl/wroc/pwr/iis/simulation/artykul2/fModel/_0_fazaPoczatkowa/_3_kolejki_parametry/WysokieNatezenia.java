package pl.wroc.pwr.iis.simulation.artykul2.fModel._0_fazaPoczatkowa._3_kolejki_parametry;
...
import pl.wroc.pwr.iis.polling.model.sterowanie.sterowniki.normal.ControlRandom;
...
public class WysokieNatezenia extends Badanie2Metod {
   	
	private static final int T_ITERACJI =15;
	...
	int[] maxCzasyOczekiwania = new int[] {20,10, Integer.MAX_VALUE};
...
//		sterownik = new ControlSelected(2);
...
//		FunkcjaOceny_I fOceny = new OcenaTimeRosnacoOrginalna(c1,c2,c3);
	...
	public static void main(String[] args) {
		WysokieNatezenia badanie = new WysokieNatezenia();
