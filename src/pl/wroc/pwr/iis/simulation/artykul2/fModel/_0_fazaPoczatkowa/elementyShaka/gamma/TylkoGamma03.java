package pl.wroc.pwr.iis.simulation.artykul2.fModel._0_fazaPoczatkowa.elementyShaka.gamma;
...
public class TylkoGamma03 extends Badanie2Metod {
	...
	public TylkoGamma03() {
		...
		TYTUL_BADANIA = "Changing only the dyskont rate to 0.3 during shake";
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
		...
		sterownik.setWLACZONY_DYSKONT(true);
		sterownik.setDyskontShake(0.3f);
	}
	
	
	public static void main(String[] args) {
		TylkoGamma03 badanie = new TylkoGamma03();
