...
public class PoissonMalejący extends Badanie2Metod {
	...
	public PoissonMalejący() {
		MAX_WARTOSC_NA_OSI_Y = 220;
		TYTUL_BADANIA = "The progressive decreasing Poisson process as the traffic queue inflow model";
...
//		sterownik2 = new QLearningModele(strategiaEzachlanna, alfa, gamma, serwerBadania.getIloscAkcji());
		serwerBadania.setSterownik(sterownik2);
	}
	
	
	public static void main(String[] args) {
		PoissonMalejący badanie = new PoissonMalejący();
