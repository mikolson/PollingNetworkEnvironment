package pl.wroc.pwr.iis.simulation.artykul2.fModel._1_zmianySkokowe.typZmiany;
...
public class ZmianaCzasowGlobalnieTakiSam extends Badanie2Metod {
	...
	int[] intentywnosciNaplywu2 = new int[] {50,30,20};
	int[] maxCzasyOczekiwania2 = new int[] {50,80, Integer.MAX_VALUE};
	
	int[] intentywnosciNaplywu3 = new int[] {50,30,20};
	int[] maxCzasyOczekiwania3 = new int[] {40,40, Integer.MAX_VALUE};

	int iteracjaZmiany[];

	
	public ZmianaCzasowGlobalnieTakiSam() {
		MAX_WARTOSC_NA_OSI_Y = 130;
		TYTUL_BADANIA = "Changing the maximum waiting time - globally constant";
		
		int iloscCykli = 30000; 
		int zmianaCyklu = 2500;
		serwerMetoda1 = new Serwer("Serwer 1",3);
		serwerMetoda2 = new Serwer("Serwer 2",3);
		setParametryEksperymentu(iloscCykli,50, 10);
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		ZmianaCzasowGlobalnieTakiSam badanie = new ZmianaCzasowGlobalnieTakiSam();
