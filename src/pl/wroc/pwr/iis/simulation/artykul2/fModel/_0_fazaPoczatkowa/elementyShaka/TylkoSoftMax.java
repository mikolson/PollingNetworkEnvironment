package pl.wroc.pwr.iis.simulation.artykul2.fModel._0_fazaPoczatkowa.elementyShaka;
...
public class TylkoSoftMax extends Badanie2Metod {
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		TylkoSoftMax badanie = new TylkoSoftMax();
