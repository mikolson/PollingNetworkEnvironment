...
public class PoissonSkokowy extends Badanie2Metod {
	...
	private IRozkladPrawdopodobienstwa rozkladObslugi = new RozkladPoissona(20);
	
	int[] intentywnosciNaplywu2 = new int[] {5,5,5}; // 17
	int[] maxCzasyOczekiwania2 = new int[] {200,40, Integer.MAX_VALUE};
	private IRozkladPrawdopodobienstwa rozkladObslugi2 = new RozkladPoissona(15);
	...
	public PoissonSkokowy() {
		...
		setParametryEksperymentu(dlugoscSymulacji,100, 50);
