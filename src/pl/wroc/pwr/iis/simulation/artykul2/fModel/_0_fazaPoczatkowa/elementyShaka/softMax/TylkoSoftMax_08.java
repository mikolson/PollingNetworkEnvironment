...
public class TylkoSoftMax_08 extends Badanie2Metod {
	...
	public TylkoSoftMax_08() {
		MAX_WARTOSC_NA_OSI_Y = 120;
		TYTUL_BADANIA = "Changing only the Temperature to the 0.8 initial value during shake";
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
		...
		sterownik.setTemperatureShake(0.8f);
	}
	
	
	public static void main(String[] args) {
		TylkoSoftMax_08 badanie = new TylkoSoftMax_08();
