...
public class ZmianaCzasow extends Badanie2Metod {
	...
	public ZmianaCzasow() {
		MAX_WARTOSC_NA_OSI_Y = 160;
		TYTUL_BADANIA = "Changing the maximum waiting time - globally decreasing";
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		ZmianaCzasow badanie = new ZmianaCzasow();
