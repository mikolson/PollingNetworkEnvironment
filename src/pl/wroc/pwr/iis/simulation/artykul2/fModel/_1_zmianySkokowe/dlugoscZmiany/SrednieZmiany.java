package pl.wroc.pwr.iis.simulation.artykul2.fModel._1_zmianySkokowe.dlugoscZmiany;
...
public class SrednieZmiany extends Badanie2Metod {
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		SrednieZmiany badanie = new SrednieZmiany();
