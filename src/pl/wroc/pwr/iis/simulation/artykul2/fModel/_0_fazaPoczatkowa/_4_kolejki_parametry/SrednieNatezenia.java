package pl.wroc.pwr.iis.simulation.artykul2.fModel._0_fazaPoczatkowa._4_kolejki_parametry;
...
public class SrednieNatezenia extends Badanie2Metod {
	...
	int[] intentywnosciNaplywu = new int[] {10,10,10, 30};
	int[] maxCzasyOczekiwania = new int[] {80,50,30, Integer.MAX_VALUE};
	...
	public SrednieNatezenia() {
		int iloscCykli = 5000; 
		int zmianaCyklu =100000;
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		SrednieNatezenia badanie = new SrednieNatezenia();
