package pl.wroc.pwr.iis.simulation.artykul2.fModel._0_fazaPoczatkowa.elementyShaka.alfa;
...
public class TylkoAlfa_005 extends Badanie2Metod {
	...
	public TylkoAlfa_005() {
		MAX_WARTOSC_NA_OSI_Y = 120;
		TYTUL_BADANIA = "Changing only the learning rate to 0.05 during shake";
...
//		sterownik = new QLearning(strategiaEzachlanna, alfa, gamma);
		...
		sterownik.setWLACZONA_ALFA(true);
		sterownik.setAlfaShake(0.05f);
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		TylkoAlfa_005 badanie = new TylkoAlfa_005();
