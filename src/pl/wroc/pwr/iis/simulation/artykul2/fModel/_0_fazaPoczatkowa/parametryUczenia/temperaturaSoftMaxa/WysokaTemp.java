package pl.wroc.pwr.iis.simulation.artykul2.fModel._0_fazaPoczatkowa.parametryUczenia.temperaturaSoftMaxa;
...
public class WysokaTemp extends Badanie2Metod {
   	
	private static final int T_ITERACJI = 150;
	private static final float T_KONIEC = 30f;
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		WysokaTemp badanie = new WysokaTemp();
