...
public class TylkoAlfa_01 extends Badanie2Metod {
	...
	public TylkoAlfa_01() {
		...
		TYTUL_BADANIA = "Changing only the learning rate to 0.1 during shake";
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		TylkoAlfa_01 badanie = new TylkoAlfa_01();
