package pl.wroc.pwr.iis.simulation.artykul2.fModel._0_fazaPoczatkowa.elementyShaka.softMax;
...
public class TylkoSoftMax_05 extends Badanie2Metod {
	...
	public TylkoSoftMax_05() {
		MAX_WARTOSC_NA_OSI_Y = 120;
		TYTUL_BADANIA = "Changing only the Temperature to the 0.5 initial value during shake";
		
		int iloscCykli = 30000; 
		int zmianaCyklu = 5000;
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
		...
		sterownik.setWYLACZ_WSZYSTKIE_WSPOMAGACZE();
		sterownik.setWLACZONY_SHAKE_STRATEGII(true);
		sterownik.setTemperatureShake( 0.5f);
	}
	
	
	public static void main(String[] args) {
		TylkoSoftMax_05 badanie = new TylkoSoftMax_05();
