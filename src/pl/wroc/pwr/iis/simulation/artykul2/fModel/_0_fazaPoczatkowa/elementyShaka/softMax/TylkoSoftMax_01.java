...
public class TylkoSoftMax_01 extends Badanie2Metod {
	...
	public TylkoSoftMax_01() {
		MAX_WARTOSC_NA_OSI_Y = 120;
		TYTUL_BADANIA = "Changing only the Temperature to the 0.1 initial value during shake";
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
		...
		sterownik.setTemperatureShake(0.1f);
	}
	
	
	public static void main(String[] args) {
		TylkoSoftMax_01 badanie = new TylkoSoftMax_01();
