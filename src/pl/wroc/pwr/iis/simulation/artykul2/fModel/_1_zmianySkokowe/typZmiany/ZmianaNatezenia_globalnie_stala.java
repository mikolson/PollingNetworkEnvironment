...
public class ZmianaNatezenia_globalnie_stala extends Badanie2Metod {
	...
	int[] intentywnosciNaplywu2 = new int[] {30,40,30};
	int[] maxCzasyOczekiwania2 = new int[] {80,50, Integer.MAX_VALUE};
	
	int[] intentywnosciNaplywu3 = new int[] {33,33,33};
	int[] maxCzasyOczekiwania3 = new int[] {80,50, Integer.MAX_VALUE};

	int iteracjaZmiany[];

	
	public ZmianaNatezenia_globalnie_stala() {
		MAX_WARTOSC_NA_OSI_Y = 120;
		TYTUL_BADANIA = "Changing the traffic intensity - globally constant";
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		ZmianaNatezenia_globalnie_stala badanie = new ZmianaNatezenia_globalnie_stala();
