...
public class TylkoGamma01 extends Badanie2Metod {
	...
	public TylkoGamma01() {
		...
		TYTUL_BADANIA = "Changing only the dyskont rate to 0.1 during shake";
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
		...
		sterownik.setDyskontShake(0.1f);
	}
	
	
	public static void main(String[] args) {
		TylkoGamma01 badanie = new TylkoGamma01();
