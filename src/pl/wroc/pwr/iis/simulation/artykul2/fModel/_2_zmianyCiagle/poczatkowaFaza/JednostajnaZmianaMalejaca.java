...
public class JednostajnaZmianaMalejaca extends Badanie2Metod {
	...
	int[] intentywnosciNaplywuStart  = new int[] {30,33,37};
	int[] maxCzasyOczekiwaniaStart 	 = new int[] {100,80, Integer.MAX_VALUE};
	
	int[] intentywnosciNaplywuKoniec= new int[] {15,15,15};
	int[] maxCzasyOczekiwaniaKoniec = new int[] {10,20, Integer.MAX_VALUE};

	int iteracjaZmianyStart = 3000;
	int iteracjaZmianyKoniec = 6000;
	
	public JednostajnaZmianaMalejaca() {
		MAX_WARTOSC_NA_OSI_Y = 120;
		TYTUL_BADANIA = "Progressive decreasing change of traffic intensity and maximum waiting time";
		
		int iloscCykli = 10000; 
		serwerMetoda1 = new Serwer("Serwer 1",3);
		serwerMetoda2 = new Serwer("Serwer 2",3);
		setParametryEksperymentu(iloscCykli,50, 5);
	}
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		JednostajnaZmianaMalejaca badanie = new JednostajnaZmianaMalejaca();
