...
public class TylkoGamma05 extends Badanie2Metod {
	...
	public TylkoGamma05() {
		...
		TYTUL_BADANIA = "Changing only the dyskont rate to 0.5 during shake";
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
		...
		sterownik.setDyskontShake(0.5f);
	}
	
	
	public static void main(String[] args) {
		TylkoGamma05 badanie = new TylkoGamma05();
