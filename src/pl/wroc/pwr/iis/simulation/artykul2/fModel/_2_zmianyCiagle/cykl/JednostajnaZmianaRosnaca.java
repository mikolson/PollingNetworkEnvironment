package pl.wroc.pwr.iis.simulation.artykul2.fModel._2_zmianyCiagle.cykl;
...
// Scenariusz 1	
//	int[] intentywnosciNaplywuStart = new int[] {50,25,25};
//	int[] maxCzasyOczekiwaniaStart = new int[] {40,20, Integer.MAX_VALUE};
//	
//	int[] intentywnosciNaplywuKoniec = new int[] {30,33,37};
//	int[] maxCzasyOczekiwaniaKoniec = new int[] {280,230, Integer.MAX_VALUE};

	int[] intentywnosciNaplywuStart = new int[] {10,15,15};
	int[] maxCzasyOczekiwaniaStart = new int[] {40,20, Integer.MAX_VALUE};
	
	int[] intentywnosciNaplywuKoniec = new int[] {30,33,37};
	int[] maxCzasyOczekiwaniaKoniec = new int[] {280,230, Integer.MAX_VALUE};

	int iteracjaZmianyStart = 20000;
	int iteracjaZmianyKoniec = 25000;
	
	public JednostajnaZmianaRosnaca() {
		MAX_WARTOSC_NA_OSI_Y = 300; 
		int iloscCykli = 35000; 
