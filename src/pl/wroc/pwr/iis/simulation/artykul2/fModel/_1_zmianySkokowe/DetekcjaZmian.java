package pl.wroc.pwr.iis.simulation.artykul2.fModel._1_zmianySkokowe;
...
public class DetekcjaZmian extends Badanie2Metod {
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		DetekcjaZmian badanie = new DetekcjaZmian();
