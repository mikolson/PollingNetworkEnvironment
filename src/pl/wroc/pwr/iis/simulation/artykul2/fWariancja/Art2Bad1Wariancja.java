...
public class Art2Bad1Wariancja extends Badanie2Metod {
	...
	int[] intentywnosciNaplywu = new int[] {30,35,35};
	int[] maxCzasyOczekiwania = new int[] {100,40, Integer.MAX_VALUE};
	
	
	public Art2Bad1Wariancja() {
	...
	protected void konfiguracjaGeneratoraLiczb() {
		RandomGenerator.setDefaultSeed(12201);
	}	
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		Art2Bad1Wariancja badanie = new Art2Bad1Wariancja();
