...
public class BadanieArt_4_2 extends Badanie2Metod {
   	
	private static final int T_ITERACJI =1000;
	private static final float T_KONIEC = 8f;
...
//	float c4 = 50;
	...
	float c3 = 50;
	float c4 = 50;
	float epsilonZachlannosci = 0.005f;
	float alfa = 0.001f; // poprawa Q
	float gamma = 0.65f; // 
	
	int[] intentywnosciNaplywu = new int[] {50,30,15};
	int[] maxCzasyOczekiwania = new int[] {400,300, Integer.MAX_VALUE};

	int[] intentywnosciNaplywu2 = new int[] {30,20,50};
	int[] maxCzasyOczekiwania2 = new int[] {250,350, Integer.MAX_VALUE};
	int iteracjaZmiany = 6000;
	
	public BadanieArt_4_2() {
		serwerMetoda1 = new Serwer("Serwer 1",3);
		serwerMetoda2 = new Serwer("Serwer 2",3);
		setParametryEksperymentu(15000,20, 50);
	}
	
	@Override
	protected void konfiguracjaGeneratoraLiczb() {
		RandomGenerator.setDefaultSeed(1221);
	}	
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		BadanieArt_4_2 badanie = new BadanieArt_4_2();
