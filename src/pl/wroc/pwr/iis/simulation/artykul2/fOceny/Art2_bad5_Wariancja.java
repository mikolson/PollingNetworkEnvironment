...
public class Art2_bad5_Wariancja extends Badanie2Metod {
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		Art2_bad5_Wariancja badanie = new Art2_bad5_Wariancja();
