package pl.wroc.pwr.iis.simulation.artykul3_multiModel;
...
import pl.wroc.pwr.iis.polling.model.sterowanie.sterowniki.Qlearning.QLearningModele;
...
public class ZmianaNatezenia_zmienna extends Badanie2Metod {
	...
	int[] intentywnosciNaplywu2 = new int[] {25,25,25};
	int[] maxCzasyOczekiwania2 = new int[] {80,50, Integer.MAX_VALUE};
	
	int[] intentywnosciNaplywu3 = new int[] {10,10,10};
	int[] maxCzasyOczekiwania3 = new int[] {80,50, Integer.MAX_VALUE};

	int iteracjaZmiany[];

	
	public ZmianaNatezenia_zmienna() {
		MAX_WARTOSC_NA_OSI_Y = 90;
		TYTUL_BADANIA = "Changing the traffic intensity - globally decreasing";
		
		int iloscCykli = 200000; 
		int zmianaCyklu = 2500;
		serwerMetoda1 = new Serwer("Serwer 1",3);
		serwerMetoda2 = new Serwer("Serwer 2",3);
		setParametryEksperymentu(iloscCykli,10, 50);
...
//		sterownik = new SarsaOnPolicy(strategiaEzachlanna, alfa, gamma);
	...
	public static void main(String[] args) {
		ZmianaNatezenia_zmienna badanie = new ZmianaNatezenia_zmienna();
