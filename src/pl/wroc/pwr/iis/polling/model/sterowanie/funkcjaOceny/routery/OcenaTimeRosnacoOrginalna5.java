...
/**
 * Ocena uwzględnia tylko czas oczekiwania pierwszego pakietu w kolejce
 * 
 * @author Misiek
 */
public class OcenaTimeRosnacoOrginalna5 extends OcenaSytuacji_A implements FunkcjaOceny_I {
	...
	public OcenaTimeRosnacoOrginalna5(float C1, float C2, float C3, float C4) {
		c1 = C1;
		c2 = C2;
		c3 = C3;
		c4 = C4;
