 ...
 * 
 *  $Revision: 676 $
 *  $Date: 2009-02-09 02:15:04 +0100 (pon) $
...
/**
 * This is a very simple environment with discrete observations corresponding to
 * states labeled {0,1,...,19,20} The starting state is 10.
 * 
 * There are 2 actions = {0,1}. 0 decrements the state, 1 increments the state.
 * 
 * The problem is episodic, ending when state 0 or 20 is reached, giving reward
 * -1 or +1, respectively. The reward is 0 on all other steps.
 * 
 * @author Brian Tanner
 */
public class PollingEnvironment extends EnvironmentBase implements HasAVisualizerInterface, HasImageInterface {
	...
	public String env_init() {
		...
		// Specify that there will be an integer observation [0,20] for the
		// state
...
class DetailsProvider implements hasVersionDetails {
    ...
    public String getName() {
        return "Polling Network Environment .1 Beta";
    }

    public String getShortName() {
        return "Polling Network";
    }

    public String getAuthors() {
        return "Michał Stanek";
    }
